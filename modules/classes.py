...
class company():
    ...
    """
    def __init__(self, ticker_symbol, initial_statements=[]):
        """
        ...
        self.income_statement = get_income_statement(ticker_symbol) if 'income-statement' in initial_statements else dict()
